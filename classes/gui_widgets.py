...
# Form implementation generated from reading ui file 'uis/SvF_GUI.ui'
#
...
"            }")
        ...
        self.savedatabutton.setGeometry(QtCore.QRect(10, 90, 131, 31))
...
"                }")
        ...
        self.recordbutton.setGeometry(QtCore.QRect(170, 90, 131, 31))
...
"            }")
        ...
        self.framelabel.setGeometry(QtCore.QRect(160, 60, 121, 21))
...
"            }")
        ...
        self.exposurelabel.setGeometry(QtCore.QRect(20, 120, 111, 25))
        ...
        self.exposurebox.setGeometry(QtCore.QRect(20, 150, 111, 35))
        ...
        self.objectivelabel.setGeometry(QtCore.QRect(180, 120, 111, 25))
        ...
        self.objectivebox.setGeometry(QtCore.QRect(180, 150, 111, 35))
        ...
        self.apply_button = QtWidgets.QPushButton(self.frame_3)
        self.apply_button.setGeometry(QtCore.QRect(10, 190, 281, 31))
        self.apply_button.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
...
"")
        ...
        self.robotmasklowerbox.setGeometry(QtCore.QRect(110, 190, 141, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setItalic(False)
        ...
        self.robotmaskdilationbox.setGeometry(QtCore.QRect(110, 250, 141, 21))
        ...
        self.robotcroplengthbox.setGeometry(QtCore.QRect(110, 130, 141, 21))
        ...
        self.croplengthlabel.setGeometry(QtCore.QRect(10, 130, 81, 25))
        ...
        self.robotmaskblurbox.setGeometry(QtCore.QRect(110, 160, 141, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setItalic(False)
        ...
        self.maskblurlabel.setGeometry(QtCore.QRect(10, 160, 61, 25))
        ...
        self.maskbutton.setGeometry(QtCore.QRect(10, 10, 101, 21))
...
"            }")
        ...
        self.robotmaskupperbox.setGeometry(QtCore.QRect(110, 220, 141, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setItalic(False)
        ...
        self.maskthreshlabel_2.setGeometry(QtCore.QRect(10, 220, 81, 25))
        self.maskthreshlabel_2.setMaximumSize(QtCore.QSize(150, 25))
        self.maskthreshlabel_2.setObjectName("maskthreshlabel_2")
        self.maxspeedbox = QtWidgets.QSpinBox(self.trackerparamsframe)
        self.maxspeedbox.setGeometry(QtCore.QRect(110, 100, 141, 21))
        self.maxspeedbox.setMinimum(1)
        self.maxspeedbox.setMaximum(250)
        self.maxspeedbox.setSingleStep(1)
        self.maxspeedbox.setProperty("value", 100)
        self.maxspeedbox.setDisplayIntegerBase(10)
        self.maxspeedbox.setObjectName("maxspeedbox")
        self.croplengthlabel_2 = QtWidgets.QLabel(self.trackerparamsframe)
        self.croplengthlabel_2.setGeometry(QtCore.QRect(10, 100, 81, 25))
        self.croplengthlabel_2.setMaximumSize(QtCore.QSize(150, 25))
        self.croplengthlabel_2.setObjectName("croplengthlabel_2")
        self.croplengthlabel_4 = QtWidgets.QLabel(self.trackerparamsframe)
        self.croplengthlabel_4.setGeometry(QtCore.QRect(10, 70, 91, 25))
        self.croplengthlabel_4.setMaximumSize(QtCore.QSize(150, 25))
        self.croplengthlabel_4.setObjectName("croplengthlabel_4")
        self.arrival_threshbox = QtWidgets.QSpinBox(self.trackerparamsframe)
        self.arrival_threshbox.setGeometry(QtCore.QRect(110, 70, 141, 21))
        self.arrival_threshbox.setMinimum(2)
        self.arrival_threshbox.setMaximum(200)
        self.arrival_threshbox.setSingleStep(1)
        self.arrival_threshbox.setProperty("value", 15)
        self.arrival_threshbox.setDisplayIntegerBase(10)
        self.arrival_threshbox.setObjectName("arrival_threshbox")
        self.croplengthlabel_5 = QtWidgets.QLabel(self.trackerparamsframe)
        self.croplengthlabel_5.setGeometry(QtCore.QRect(10, 40, 91, 25))
        self.croplengthlabel_5.setMaximumSize(QtCore.QSize(150, 25))
        self.croplengthlabel_5.setObjectName("croplengthlabel_5")
        self.nodenumbox = QtWidgets.QSpinBox(self.trackerparamsframe)
        self.nodenumbox.setGeometry(QtCore.QRect(110, 40, 141, 21))
        self.nodenumbox.setMinimum(2)
        self.nodenumbox.setMaximum(200)
        self.nodenumbox.setSingleStep(1)
        self.nodenumbox.setProperty("value", 52)
        self.nodenumbox.setDisplayIntegerBase(10)
        self.nodenumbox.setObjectName("nodenumbox")
...
"            }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.croplengthlabel_2.setText(_translate("MainWindow", "Max Speed"))
        self.croplengthlabel_4.setText(_translate("MainWindow", "Arrival Thresh"))
        self.croplengthlabel_5.setText(_translate("MainWindow", "Node Num"))
